            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        {{ __('Employeers Listing') }}
                        <button style="float: right; font-weight: 900;" class="btn btn-info btn-sm" type="button"  data-toggle="modal" data-target="#CreateEmployeerModel">
                          ( <i class="fa fa-plus"></i>) Add Employeer
                        </button>
                    </div>
...
<div class="modal" id="CreateEmployeerModel">
    <div class="modal-dialog">
        <div class="modal-content">
        <form id="CreateFreelanceForm">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Add Employeer</h4>
            ...
            <div class="modal-body">
                ...
                <div class="alert-success alert-dismissible fade show mb-3" role="alert" style="display: none;">
                    <strong>Success!</strong> Employeer added successfully.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert-success alert-dismissible fade show mb-3" role="alert" style="display: none;">
                    <strong>Success!</strong>Employeer was added successfully.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<div class="modal" id="DeleteArticleModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Employeer Delete</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal body -->
            <div class="modal-body">
            ...
            $.ajax({
                ...
                success: function(result) {
                    if(result.errors) {
                        ...
                        $('.alert-success').hide();
                        $('#CreateEmployeerModel').modal('hide');
                        //reset-form-fields
