            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  <select class="form-control" name="category_id" id="category_id">
                     ...
                     @foreach ($sub_categ_all as $key=>$value)
               ...
               {{-- description --}}
               <div class="form-group">
                  <textarea  class="form-control" name="abstract" id="abstract" placeholder="Enter Abstract"></textarea>
               </div>
            </div>
            <!-- Modal footer -->
           ...
           $.ajax({
               ...
               success: function(result) {
                   if(result.errors) {
                       ...
                       getMessage('Success','top-right','Sub-Category Added Successfully');
                   }
               }
           });
       });
           ...
           $.ajax({
               ...
               success: function(result) {
                   if(result.errors) {
                       ...
                       $('.alert-success').hide();
                       $('#EditLocationModal').hide();
                       getMessage('Success','top-right','Sub-Category Updated Successfully');
                   }
               }
           });
       });
