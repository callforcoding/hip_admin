    ...
    <div class="modal-dialog">
        ...
        <form id="CreateModalForm">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <textarea  class="form-control" name="slug" id="slug" placeholder="Enter Slug"></textarea>
                </div>
                <div class="form-group">
                    <textarea  class="form-control" name="cost" id="cost" placeholder="Enter Cost"></textarea>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function(result) {
                    if(result.errors) {
                        ...
                        getMessage('Success','top-right','Package Added Successfully');
                    }
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function(result) {
                    if(result.errors) {
                        ...
                        $('.alert-success').hide();
                        $('#EditLocationModal').hide();
                        getMessage('Success','top-right','Package Updated Successfully');
                    }
                }
            });
        });
