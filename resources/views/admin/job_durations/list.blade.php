...
<div class="modal" id="DeleteArticleModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Job Duration Delete</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal body -->
            <div class="modal-body">
            ...
            $.ajax({
                ...
                success: function(result) {
                    if(result.errors) {
                        ...
                        getMessage('Success','top-right','Job Duration Added Successfully');
                    }
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function(result) {
                    if(result.errors) {
                        ...
                        $('.alert-success').hide();
                        $('#EditLocationModal').hide();
                        getMessage('Success','top-right','Job Duration Updated Successfully');
                    }
                }
            });
        });
